export const POKEMON_TRAINER_ABI = [
  {
...
export const POKEMON_BATTLE_ABI = [
  {
    name: "NewBattle",
    inputs: [
      { type: "bytes32", name: "trainerPokemonName", indexed: false },
...
export const POKEMON_TRAINER_ADDRESS = "0x663cA8C20Edfe469fD0E8785e202b8db07FB019C";
export const POKEMON_BATTLE_ADDRESS = "0xcBCB471168893317055be87eADc0f08A4Abb49ee";
